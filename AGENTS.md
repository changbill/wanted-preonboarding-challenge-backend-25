...
- `PLAN.md`는 기존 단계의 todo 체크 상태만 갱신한다.
...
- phase 완료 요약, 검증 결과, 남은 위험은 `PLAN.md`가 아니라 `_workspace/codex/{phase}/implementation.md`, `verification.md`, 필요 시 `RESEARCH.md` 또는 `SPEC.md`에 기록한다.
